       ...
       <form className='relative bg-white p-10 rounded-xl text-slate-500' >
        ...
        : <>
            ...
            <div className='border px-4 py-2 flex items-center gap-2 rounded-full mt-5'>
                ...
                <input className='outline-none text-sm' onChange={e => setEmail(e.target.value)} type='email' placeholder='Email Address' value={email} required />
            </div>
            <div className='border px-4 py-2 flex items-center gap-2 rounded-full mt-5'>
                <img src={assets.lock_icon} alt="" />
                <input className='outline-none text-sm' onChange={e => setPassword(e.target.value)} type='password' placeholder='Enter password' value={password} required />
            </div>
