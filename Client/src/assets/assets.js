...
import hero_image from './heroimage.png'
 ...
 export const testimonials = [
    {
      name: "Mary Mansah",
      role: "Hair dresser",
      company: "Hired at BeautyView",
      content:
        "The multimedia profile feature allowed me to showcase my skills in a way that a traditional resume never could. I received multiple interview offers within a week of creating my profile.",
      avatar: "SJ",
    },
    {
      name: "Michael Chen",
      ...
      content:
        "As a hiring manager, this platform has revolutionized our recruitment process. The ability to see candidates' video introductions before interviews saves us tremendous time and resources.",
      avatar: "MC",
    },
    {
      name: "Priya Patel",
      role: "Graphic Designer",
      company: "Hired at CreativeStudio",
      content:
        "Being able to upload my portfolio directly to my profile made all the difference. Companies could immediately see my work, and I found my dream job within a month!",
      avatar: "PP",
    },
    {
      name: "James Wilson",
      ...
      content:
        "The statistics dashboard helps us track our hiring performance and motivates our team to improve. The badge system adds a fun competitive element to our recruitment efforts.",
      avatar: "JW",
    },
  ]
